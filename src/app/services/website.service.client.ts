...
export class WebsiteService {
    ...
    websites: Website[] = [
        new Website('321', 'Facebook', '123', 'Blogger Post' ),
        new Website('111', 'Facebook1', '123', 'Blogger' ),
        new Website('222', 'Facebook2', '123', 'Blogging App' ),
        new Website('333', 'Facebook3', '123', 'Script Testing App' ),
